...
#'
(Tukey.Tratd.L1 <- with(subset(data, Local == "L1"),
                        HSD.test(altura, 
                                 Trat,
                                 45,
                                 3.0)))
...
#'
(Tukey.Tratd.L2 <- with(subset(data, Local == "L2"),
                        HSD.test(altura, 
                                 Trat,
                                 45,
                                 3.0)))
...
#'
(Tukey.Tratd.L3 <- with(subset(data, Local == "L3"),
                        HSD.test(altura, 
                                 Trat,
                                 45,
                                 3.0)))
